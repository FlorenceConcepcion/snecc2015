...
#testlist = ['12eaw_LC.npy', '12dcp_LC.npy', '10inj_LC.npy', '10feq_LC.npy', '11izq_LC.npy']
ib=ic=0
...
source_names = ['s11-2005hl', 's11-2005hm', 'snana-2004gv', 'snana-2006ep', 'snana-2007y', 'snana-2004ib', 'snana-2005hm', 'snana-2007nc']#'snana-2006jo']#, 
#source_name = 's11-2005hm'
#source=sncosmo.get_source(source_name) 
#model=sncosmo.Model(source=source)
jo=jp=1
listofchimodel = []
...
plt.hist(peakabsmagvalue, bins = redchilimit/1.5, label = [str(ib) + ' Ib datapoints' ], color = ['blue']) #, stacked=True)
#plt.hist(peakabsmagvaluec, bins = redchilimit/0.5, label = str(ic) + ' datapoints', color = 'green',stacked=True)
plt.title("Peak Absolute Magnitude Histogram of TypeIb using " + source_name)
...
plt.hist(redchi, bins = redchilimit/1.5, label = [str(ib) + ' Ib datapoints'], color = ['blue']) #, stacked=True)
#plt.hist(redchic, bins = redchilimit/0.5, label = str(ic) + ' datapoints', color = 'green')

plt.title("Reduced Chi Squared Distribution of TypeIb using " + source_name)
