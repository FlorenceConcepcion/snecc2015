...
plt.hist(peakabsmagvalue, bins = redchilimit/2, label = [str(ib) + ' Ib datapoints',str(ic) + ' Ic datapoints' ], color = ['blue','green'], stacked=True)
...
plt.hist(redchi, bins = redchilimit/2, label = [str(ib) + ' Ib datapoints',str(ic) + ' Ic datapoints' ], color = ['blue','green'], stacked=True)
