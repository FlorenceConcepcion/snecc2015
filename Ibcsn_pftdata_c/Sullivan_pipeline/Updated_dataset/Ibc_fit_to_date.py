...
tempcompletesnlist = ['10aavz', '10acbu', '10acff', '10acgq', '10bhu', '10bip', '10bzf', '10ciw', '10eqi', '10fbv', '10feq', '10fmx', '10gvb', '10hfe', '10hie', '10inj', '10iue', '10kui', '10lbo', '10osn', '10qif', '10qqd', '10qts', '10svt', '10tqi', '10tqv', '10vnv', '10xem', '10xik', '10xjr', '10ysd', '10zcn','11bli', '11bov', '11cmh', '11gcj', '11hyg', '11ilr', '11img', '11ixk', '11izq', '11jgj', '11kaa', '11klg', '11lbm', '11mnb', '11mwk', '11qcj', '11qiq', '11rka', '12as', '12cde', '12cjy', '12dcp', '12dtf', '12eaw', '12gdy', '12gzk', '12hni', '12jxd', '12ktu', '12lpo', '12mfx']
...
plt.hist(peakabsmagvalue, bins = 6, label = [str(ib) + ' Ib datapoints',str(ic) + ' Ic datapoints' ], color = ['blue','green'])#, stacked=True)
...
plt.hist(redchi, bins = 6, label = [str(ib) + ' Ib datapoints',str(ic) + ' Ic datapoints' ], color = ['blue','green'])#, stacked=True)
