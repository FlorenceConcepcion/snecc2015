...
hist(peakabsmagvaluec, bins = 'knuth', label = str(ic) + ' Ic datapoints', color ='green', histtype='stepfilled', alpha=0.2)#, stacked=True)
...
#hist(redchi, bins = 6, label = [str(ib) + ' Ib datapoints',str(ic) + ' Ic datapoints' ], color = ['blue','green'])#, stacked=True)
...
hist(allredshifts, bins = 'knuth', label = str(len(allredshifts)) + ' sn available' , color = 'blue', histtype='stepfilled', alpha=0.2)    #, stacked=True)
hist(totalred, bins = 'knuth', label = str(ic +ib) + ' sn in sample used' , color = 'black', histtype='step')    #, stacked=True)
