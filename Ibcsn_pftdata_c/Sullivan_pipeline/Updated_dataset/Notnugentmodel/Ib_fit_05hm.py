...
plt.title("Reduced Chi Squared Distribution of TypeIb/c using the s11-2005hm model")
...
plt.title("Redshift Distribution of TypeIb/c using the s11-2005hm model")
plt.xlabel("Redshift")
plt.ylabel("Frequency")
plt.legend()
