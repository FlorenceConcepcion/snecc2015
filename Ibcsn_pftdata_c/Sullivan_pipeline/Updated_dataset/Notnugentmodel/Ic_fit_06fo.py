...
plt.title("Peak Absolute Magnitude Histogram of TypeIb and TypeIc using the s11-2006fo model")
...
plt.title("Reduced Chi Squared Distribution of TypeIb/c using the s11-2006fo model")
...
plt.title("Redshift Distribution of TypeIb/c using the s11-2006fo model")
plt.xlabel("Redshift")
plt.ylabel("Frequency")
plt.legend()
