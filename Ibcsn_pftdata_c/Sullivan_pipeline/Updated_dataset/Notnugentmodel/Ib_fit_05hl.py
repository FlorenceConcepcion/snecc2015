...
def modellimit(z0):
    source=sncosmo.get_source('s11-2005hl') 
...
result = hist(peakabsmagvalueb, bins = 4, label = str(ib) + ' Ib datapoints', color = 'blue', histtype='stepfilled', alpha=0.2)#, stacked=True)
...
plt.title("Peak Absolute Magnitude Histogram of TypeIb and TypeIc using the s11-2005hl model")
...
plt.title("Reduced Chi Squared Distribution of TypeIb/c using the s11-2005hl model")
...
plt.title("Redshift Distribution of TypeIb/c using the s11-2005hl model")
plt.xlabel("Redshift")
plt.ylabel("Frequency")
plt.legend()
