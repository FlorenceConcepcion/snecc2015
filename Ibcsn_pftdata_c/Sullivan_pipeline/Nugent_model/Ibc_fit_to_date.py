...
def showcurve(sn, hml):
    for i in range(1):
        ...
        mjdlimits = {'0': (55197, 55562), '1': (55562, 55927), '2': (55927, 56293)}
        
        res, fitted_model=sncosmo.fit_lc(hml_dat, model, ['t0','amplitude'], nburn=10000, nsamples=50000, bounds={'t0':mjdlimits[sn[1]]})
        ...
        if j > 1 and k>1:
            ...
            res2, fitted_model2=sncosmo.fit_lc(hml_dat2, model, ['t0','amplitude'], nburn=10000, nsamples=50000, bounds={'t0':mjdlimits[sn[1]]})
...
betterdataneeded = [ '10bhu', '12fgw', '11klg', '10ysd', '10bip', '10fia', '12lpo', '12elh', '10hcw', '11hyg', '10hie', '10uhn', '11rfh', '10bfz', '11all', '10eqi', '12lvt', '12bwq']

tempcompletesnlist = ['10osn', '10ciw', '12mfx', '10xem', '10bhu', '11pnq', '12ktu', '12fgw', '10qts', '11klg', '11cmh', '12cde', '10hfe', '11ixk', '11bov', '10ysd', '10bip', '10fia', '11oni', '12lpo', '12elh', '12cjy', '10hcw', '12gvr', '10fbv', '11img', '10zcn', '11izq', '10kui', '12fsu', '11gcj', '12dcp', '10svt', '10vnv', '12eaw', '12hni', '10qqd', '11bli', '11hyg', '10hie', '10xik', '10inj', '10lbo', '10qif', '12jxd', '10uhf', '10uhn', '11rka', '10feq', '10bzf', '10gvb', '11ilr', '10xjr', '10fmx', '10iue', '10hgi', '12dtf', '12fes', '12gzk', '12grr', '11qcj', '11rfh', '11jgj', '10bfz', '10tqv', '11all', '11mnb', '10eqi', '10tqi', '12lvt', '12bwq', '11mwk', '11qiq', '12hvv']

completesnlist = betterdataneeded
...
print betterdataneeded
#print j
'''
    
plt.subplot(211)  
peakabsmagvalue = [peakabsmagvalueb,peakabsmagvaluec] 
plt.hist(peakabsmagvalue, bins = 15, label = [str(ib) + ' Ib datapoints',str(ic) + ' Ic datapoints' ], color = ['blue','green'])#, stacked=True)
...
plt.hist(redchi, bins = 15, label = [str(ib) + ' Ib datapoints',str(ic) + ' Ic datapoints' ], color = ['blue','green'])#, stacked=True)
