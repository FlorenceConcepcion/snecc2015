...
def Gen_SN():
	...
	model.set(z=0.1,t0=30) #Setting redshift
	...
	fluxlc=model.bandflux('f070w',timearray) #Creating a flux array of the lightcurve
	maglc2=model.bandmag('bessellr','ab',timearray) #Creating a magnitude array of the lightcurve 
	maglc3=model.bandmag('bessellv','ab',timearray) #Creating a magnitude array of the lightcurve 
	maglc4=model.bandmag('besselli','ab',timearray) #Creating a magnitude array of the lightcurve 
	maglc5=model.bandmag('bessellux','ab',timearray) #Creating a magnitude array of the lightcurve 

	
	plt.scatter(timearray, maglc, color= 'blue')
	plt.scatter(timearray, maglc2, color = 'red')
	plt.scatter(timearray, maglc3, color = 'green')
	plt.scatter(timearray, maglc4, color = 'black')
	plt.scatter(timearray, maglc5, color = 'purple')
